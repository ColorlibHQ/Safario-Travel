...
<div class="copyright-text footer-bottom">
    <div class="container">
        <div class="row align-items-center">
            <p class="col-lg-8 col-sm-12 footer-text m-0 text-center text-lg-left"><?php echo wp_kses_post( safariotravel_opt( 'safariotravel-copyright-text-settings', $copyText ) ); ?></p>
            <?php
            if( has_nav_menu( 'social-menu' ) ) {
                echo '<div class="col-lg-4 col-sm-12 footer-social text-center text-lg-right">';
                    $args = array(
                        ...
                        'fallback_cb'    => 'safariotravel_social_navwalker::fallback',
                        'walker'         => new safariotravel_social_navwalker(),
                    );  
                    wp_nav_menu( $args );
                echo '</div>';
            }
