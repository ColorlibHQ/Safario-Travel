 ...
 * @since 1.0
 */
class safariotravel_Cta extends Widget_Base {

	public function get_name() {
		return 'safariotravel-cta';
	}

	public function get_title() {
		return __( 'Call to Action', 'safariotravel' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'sh_content',
            [
                'label' => __( 'Select Call to Action Style', 'safariotravel' ),
            ]
        );
        $this->add_control(
            'select_cta',
            [
                'label'       => esc_html__( 'Select Call to Action Style', 'safariotravel' ),
                'label_block' => true,
                'type'        => Controls_Manager::SELECT,
                'options'      => [
                    'style_1'   => esc_html__('Style One', 'safariotravel'),
                    'style_2'   => esc_html__('Style Two', 'safariotravel')
                ],
                'default'     => 'style_1'
            ]
        );
        ...
        $this->start_controls_section(
            'single_cta_sec',
            [
                'label' => __( 'Call to Action', 'safariotravel' ),
            ]
        );
        $this->add_control(
            'cta_title',
            [
                ...
                'default'     => esc_html__( "It's never late to start, join us today!", "safariotravel" )
            ]
        );
        $this->add_control(
            'cta_description',
            [
                ...
                'default'     => esc_html__( 'Thinking about overseas adventure travel? Have you put any thought into the best places to go when it comes to overseas adventure travel? Nepal is one of the most popular places of all.', 'safariotravel' ),
                'condition'   => [
                    'select_cta' => 'style_1'
                ]
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( 'Become a Member', 'safariotravel' )
            ]
        );
        $this->add_control(
            'cta_btn_url',
        ...
        $this->start_controls_section(
            'style_cta_2', [
                'label' => __( 'Style CTA Dual Column', 'safariotravel' ),
