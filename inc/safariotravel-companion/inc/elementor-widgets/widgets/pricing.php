 ...
 * @since 1.0
 */
class safariotravel_Pricing extends Widget_Base {

	public function get_name() {
		return 'safariotravel-pricing';
	}

	public function get_title() {
		return __( 'Pricing', 'safariotravel' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'pricing_table_sec',
            [
                'label' => __( 'Pricing Table', 'safariotravel' ),
            ]
        );

        $this->add_control(
            'pricing_table', [
                'label'         => __( 'Create Pricing Table', 'safariotravel' ),
                ...
                'fields' => [
                    [
                        ...
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html__( 'Normal', 'safariotravel' )
                    ],
                    [
                        'name'        => 'sub_title',
                        ...
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html__( 'Attend only first day', 'safariotravel' )
                    ],
                    [
                        'name'        => 'price',
                        'label'       => esc_html__( 'Price', 'safariotravel' ),
                        'type'        => Controls_Manager::TEXT,
                        
                    ],
                    [
                        'name'        => 'feature_list',
                        'label'       => esc_html__( 'Feature List', 'safariotravel' ),
                    ...
                    [
                        ...
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html( 'Buy Now', 'safariotravel' )
                    ],
                    [
                        'name'        => 'btn_url',
        ...
        $this->start_controls_section(
            'style_pricing_item', [
                'label' => esc_html__( 'Style Pricing Item', 'safariotravel' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'item_bg', [
                'label'     => esc_html__( 'Pricing Item Background Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'item_hover_bg', [
                'label'     => esc_html__( 'Pricing Item Hover Background Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#3b1d82',
                'selectors' => [
        ...
        $this->add_control(
            'item_buy_btn_bg', [
                'label'     => esc_html__( 'Pricing Item Button Background', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#f7f7f7',
                'selectors' => [
        ...
        $this->add_control(
            'item_buy_btn_hover_bg', [
                'label'     => esc_html__( 'Button Hover Background', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#ea0763',
                'selectors' => [
        ...
        $this->add_control(
            'item_buy_btn_border', [
                'label'     => esc_html__( 'Pricing Item Button Border', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#eeeeee',
                'selectors' => [
        ...
        $this->add_control(
            'item_buy_btn_hover_border', [
                'label'     => esc_html__( 'Button Hover Border', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#ea0763',
                'selectors' => [
