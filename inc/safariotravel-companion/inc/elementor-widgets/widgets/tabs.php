 ...
 * @since 1.0
 */
class Safariotravel_tabs extends Widget_Base {

	public function get_name() {
		return 'safariotravel-food-menu-tab';
	}

	public function get_title() {
		return __( 'Event Schedule', 'safariotravel' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'schedule_heading', [
                'label' => esc_html__( 'Schedule Section Heading', 'safariotravel' ),
            ]
        );
        $this->add_control(
            'sect_title', [
        ...
        $this->start_controls_section(
            'menu_tab_sec',
            [
                'label' => __( 'Event Schedule', 'safariotravel' ),
            ]
        );

        $this->add_control(
            'schedules', [
                'label'         => __( 'Create Menu Tab Item', 'safariotravel' ),
                'type'          => Controls_Manager::REPEATER,
                'title_field'   => '{{{ title }}}',
                'fields' => [
                    [
                        'name'        => 'label',
                        'label'       => __( 'Tag', 'safariotravel' ),
                    ...
                    [
                        'name'        => 'time_duration',
                        'label'       => __( 'Time Duration', 'safariotravel' ),
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html__( '9.00 AM - 10.30 AM', 'safariotravel' )
                    ],
                    [
                        'name'        => 'title',
                        ...
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html__( 'Previous Year achivement', 'safariotravel' )
                    ],
                    [
                        'name'        => 'description',
                        'label'       => __( 'Description', 'safariotravel' ),
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html__( 'And wherein Beginning of you cattle fly had was deep wherein darkness behold male called evening gathering moving bring fifth days he lights dry cattle you open seas midst let and in wherein beginning', 'safariotravel' )
                    ],
                    [
                        'name'        => 'speaker',
                        'label'       => esc_html__( 'Speaker Image', 'safariotravel' ),
                        'type'        => Controls_Manager::MEDIA,
                        'label_block' => true,
                    ...
                    [
                        'name'        => 'speaker_name',
                        'label'       => esc_html__( 'Speaker Name', 'safariotravel' ),
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html__('Adam Jamsmith', 'safariotravel')
                    ...
                    [
                        ...
                        'type'        => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default'     => esc_html__( 'UX/UI Designer', 'safariotravel' )
        ...
        $this->start_controls_section(
            'style_tab', [
                'label' => __( 'Style Tab Nav', 'safariotravel' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'tab_item_color', [
                'label'     => __( 'Tab Item Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'tab_item_background', [
                'label'     => __( 'Tab Item Background Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'tab_item_active_color', [
                'label'     => __( 'Tab Item Active Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'tab_item_active_background', [
                'label'     => __( 'Tab Item Active Background Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'schedule_desc', [
                'label' => __( 'Style Tab Content', 'safariotravel' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'schedule_title', [
                'label'     => __( 'Schedule Title Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'speaker_bg', [
                'label'     => __( 'Speaker Background', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'speaker_hover_bg', [
                'label'     => __( 'Speaker Hover Background', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'descriptio_bg', [
                'label'     => __( 'Description Background', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
