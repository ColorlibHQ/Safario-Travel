...
class safariotravel_Clients extends Widget_Base {

	public function get_name() {
		return 'safariotravel-clients';
	}

	public function get_title() {
		return __( 'Clients', 'safariotravel' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'gold_sponsor',
			[
				'label' => __( 'Gold Sponsor', 'safariotravel' ),
			]
        );
        $this->add_control(
            'sponsor_title', [
                'label' => esc_html__( 'Sponsor Title', 'safariotravel' ),
                'type'  => Controls_Manager::TEXT,
                'default' => esc_html( 'GOLD SPONSOR', 'safariotravel' ),
                'label_block' => true
        ...
        $this->add_control(
            'gold_sponsor_logos', [
                'label' => esc_html__( 'Gold Sponsor Company Logos', 'safariotravel' ),
		...
		$this->start_controls_section(
			'silver_sponsor',
			[
				'label' => __( 'Silver Sponsor', 'safariotravel' ),
			]
        );
        $this->add_control(
            'silver_sponsor_title', [
                'label' => esc_html__( 'Sponsor Title', 'safariotravel' ),
                'type'  => Controls_Manager::TEXT,
                'default' => esc_html( 'SILVER SPONSOR', 'safariotravel' ),
                'label_block' => true
        ...
        $this->add_control(
            'silver_sponsor_logos', [
                'label' => esc_html__( 'Silver Sponsor Company Logos', 'safariotravel' ),
                'type'  => Controls_Manager::GALLERY,
                            ...
                            foreach( $settings['gold_sponsor_logos'] as $sponsor ): ?>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                                    <div class="sponsor-single">
                                        <?php
                                            echo '<img class="img-fluid" src="'. $sponsor['url'] .'" alt="'. esc_html__( 'Gold sponsor company logo', 'safariotravel' ) .'">';
                                        ?>
                                    </div>
                                </div>
                                <?php
                        ...
                        if( is_array( $settings['silver_sponsor_logos'] ) && count( $settings['silver_sponsor_logos'] ) > 0 ):
                            foreach( $settings['silver_sponsor_logos'] as $sponsor ): ?>
                                <div class="col-sm-6 col-lg-4 mb-3 mb-lg-0">
                                    <div class="sponsor-single">
                                        <?php
                                            echo '<img class="img-fluid" src="'. $sponsor['url'] .'" alt="'. esc_html__( 'Sliver sponsor company logo', 'safariotravel' ) .'">';
                                        ?>
                                    </div>
                                </div>
                                <?php
