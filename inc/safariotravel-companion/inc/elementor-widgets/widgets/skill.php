 ...
 * @since 1.0
 */
class safariotravel_Skill extends Widget_Base {
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'skill_content',
            [
                'label' => __( 'Skill', 'safariotravel' ),
            ]
        );
        $this->add_control(
            'skill', [
                'label' => __( 'Create skill item', 'safariotravel' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'    => 'percentage',
                        'label'   => __( 'Percentage', 'safariotravel' ),
                        'type'    => Controls_Manager::TEXT,
                        'default' => '75'
                    ]
                ],
