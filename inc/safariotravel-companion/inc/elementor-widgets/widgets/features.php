 ...
 * @since 1.0
 */
class safariotravel_Features extends Widget_Base {

	public function get_name() {
		return 'safariotravel-features';
	}

	public function get_title() {
		return __( 'Features', 'safariotravel' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'features_block',
			[
				'label' => __( 'Features', 'safariotravel' ),
			]
		);
		$this->add_control(
            'features_content', [
                'label' => __( 'Create Features', 'safariotravel' ),
                ...
                'fields' => [
                    [
                        ...
                        'type'  => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default' => __('Learn Online Courses', 'safariotravel')
                    ],
	                [
		                'name'  => 'desc',
                    ...
                    [
                        'name'  => 'icon',
                        'label' => __( 'Feature Icon', 'safariotravel' ),
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'icon_bg',
                'label' => __( 'Feature Icon Background Image', 'safariotravel' ),
                'types' => [ 'classic' ],
        ...
        $this->add_control(
            'btn_one_label', [
                'label' => esc_html__( 'Button One Label', 'safariotravel' ),
                'type'  => Controls_Manager::TEXT,
                'label_block' => true,
        ...
        $this->add_control(
            'btn_one_url', [
                'label' => esc_html__( 'Button One URL', 'safariotravel' ),
        ...
        $this->add_control(
            'btn_two_label', [
                'label' => esc_html__( 'Button Two Label', 'safariotravel' ),
                'type'  => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__('Buy Ticket', 'safariotravel')

            ]
        );
        $this->add_control(
            'btn_two_url', [
                'label' => esc_html__( 'Button Two URL', 'safariotravel' ),
                'type'  => Controls_Manager::URL,
                'label_block' => true
        ...
        $this->start_controls_section(
            'style_section_heading', [
                'label' => __( 'Style Section Title', 'safariotravel' ),
        ...
        $this->start_controls_section(
            'style_features', [
                'label' => __( 'Style Features', 'safariotravel' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Feature Title ', 'safariotravel' ),
        ...
        $this->add_control(
            'feature_hover_title', [
                'label' => __( 'Feature Hover Title Color', 'safariotravel' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'feature_desc_color', [
                'label' => __( 'Feature Description Color', 'safariotravel' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#797979',
                'selectors' => [
        ...
        $this->add_control(
            'feature_button',
            [
                'label'     => __( 'Feature Button Style ', 'safariotravel' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'feature_btn1_label_color', [
                'label' => __( 'Button One Label Color', 'safariotravel' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#242424',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_hover_label_color', [
                'label' => __( 'Button One Hover Label Color', 'safariotravel' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_border_color', [
                'label' => __( 'Button One Border Color', 'safariotravel' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#3b1d82',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_hover_border_color', [
                'label' => __( 'Button One Hover Border Color', 'safariotravel' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#3b1d82',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_bg', [
                'label' => __( 'Button One Background', 'safariotravel' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_hover_bg', [
                'label' => __( 'Button One Hover Background', 'safariotravel' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#3b1d82',
                'selectors' => [
        ...
        $this->add_control(
            'feature_button2',
            [
                'label'     => __( 'Feature Button Two Style ', 'safariotravel' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
