 ...
 * @since 1.0
 */
class safariotravel_Contact extends Widget_Base {

    public function get_name() {
        return 'safariotravel-contact';
    }

    public function get_title() {
        return __( 'Contact', 'safariotravel' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'contact_map',
            [
                'label' => __( 'Map Settings', 'safariotravel' ),
            ]
        );
        $this->add_control(
            'map_switch',
            [
                'label' => __( 'Show Map', 'safariotravel' ),
        ...
        $this->add_control(
            'map_address',
            [
                'label'         => esc_html__( 'Address', 'safariotravel' ),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__( 'Rabindra Sorobor Dhanmondi Lake Rd', 'safariotravel' ),
                'description'   => esc_html__( 'Before use map widget make sure you are set google map api key from customizer -> theme options -> general -> google map api key', 'safariotravel' )
            ]
        );
        $this->add_control(
            'map_lat',
            [
                'label'       => esc_html__( 'Latitude', 'safariotravel' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( '23.745227', 'safariotravel' )
            ]
        );
        $this->add_control(
            'map_lng',
            [
                'label'       => esc_html__( 'Longitude', 'safariotravel' ),
                'label_block' => true,
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__( '90.377155', 'safariotravel' )
            ]
        );
        ...
        $this->start_controls_section(
            'contact_info',
            [
                'label' => __( 'Contact Info', 'safariotravel' ),
            ]
        );

        $this->add_control(
            'info', [
                'label'         => __( 'Create Contact Info', 'safariotravel' ),
                ...
                'fields'  => [
                    [
                        ...
                        'label_block' => true,
                        'type'        => Controls_Manager::TEXT,
                        'default'     => esc_html__( 'Dhaka, Bangladesh', 'safariotravel' )
                    ],
                    [
                        'name'    => 'desc',
                        'label'   => __( 'Contact Descriptions', 'safariotravel' ),
                        'type'    => Controls_Manager::TEXTAREA,
                        'default' => esc_html__( 'Write something...', 'safariotravel' )
                    ],
                    [
                        'name'  => 'icon',
                        'label' => __( 'Icon', 'safariotravel' ),
                        'type'  => Controls_Manager::ICON,
                        'options' => safariotravel_themify_icon()
                    ]
        ...
        $this->add_control(
            'color_title', [
                'label'     => __( 'Address Title Color', 'safariotravel' ),
        ...
        $this->add_control(
            'color_desc', [
                'label'     => __( 'Address Description Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
        ...
        $this->add_control(
            'color_icon', [
                'label'     => __( 'Icon Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#f7631b',
                'selectors' => [
    ...
    wp_enqueue_script('safariotravel-map-custom');
