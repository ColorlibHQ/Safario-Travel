 ...
 * @since 1.0
 */
class Safariotravel_search_package extends Widget_Base {

	public function get_name() {
		return 'safariotravel-search-package';
	}

	public function get_title() {
		return __( 'Search Package', 'safariotravel' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'search_package',
            [
                'label' => esc_html__( 'Search Package', 'safariotravel' ),
            ]
        );
        $this->add_control(
            'info_title', [
                'label'      => esc_html__( 'Info Title', 'safariotravel' ),
                'description'=> esc_html__('Use <br> for line barck', 'safariotravel'),
                'type'       => Controls_Manager::TEXTAREA,
                'default'    => __('Search suitable <br> and affordable plan <br> for your tour', 'safariotravel')
            ]
        );
        $this->add_control(
            'info_desc', [
                'label'      => esc_html__( 'Info Description', 'safariotravel' ),
                'type'       => Controls_Manager::WYSIWYG,
                'default'    => __('Make she moved divided air. Whose tree that replenish tone hath own upon them it multiply was blessed is lights make gathering so day dominion so creeping', 'safariotravel')
            ]
        );
        $this->add_control(
            'btn_label', [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__( 'Search Package Shortcode', 'safariotravel' ),
            ]
        );
        $this->add_control(
            'search_form_title', [
                'label'      => esc_html__( 'Search Form Title', 'safariotravel' ),
                'type'       => Controls_Manager::TEXT,
                'default'    => Esc_html__( 'Search Package', 'safariotravel' ),
                'label_block' => true
            ]
        );
        $this->add_control(
            'tour_search_shortcode', [
                'label'      => esc_html__( 'Shortcode ', 'safariotravel' ),
                'type'       => Controls_Manager::TEXT,
                'label_block' => true
            ]
        );
        ...
        $this->start_controls_section(
            'style_info', [
                'label' => __( 'Style Info Content', 'safariotravel' ),
