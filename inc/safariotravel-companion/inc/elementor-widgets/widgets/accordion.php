 ...
 * @since 1.0
 */
class safariotravel_Accordion extends Widget_Base {

	public function get_name() {
		return 'safariotravel-accordion';
	}

	public function get_title() {
		return __( 'Accordion', 'safariotravel' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'accordion_heading',
            [
                'label' => esc_html__( 'Accordion Section Heading', 'safariotravel' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'accordion_block',
			[
				'label' => esc_html__( 'Accordion', 'safariotravel' ),
			]
        );
        ...
        $this->start_controls_section(
            'section_video',
            [
                'label' => esc_html__( 'Vedio Settings', 'safariotravel' ),
            ]
        );
        $this->add_control(
            'accordion_video_url', [
                'label' => esc_html__( 'YouTube Vedio URL', 'safariotravel' ),
        ...
        $this->add_control(
            'paly_icon_select', [
                'label' => esc_html__( 'Vedio Play Icon Select', 'safariotravel' ),
        ...
        $this->add_control(
            'video_paly_icon', [
                'label' => esc_html__( 'Vedio Play Image Icon', 'safariotravel' ),
        ...
        $this->add_control(
            'video_paly_fonticon', [
                'label' => esc_html__( 'Vedio Play Font Icon', 'safariotravel' ),
        ...
        $this->start_controls_section(
            'style_section', [
                'label' => esc_html__( 'Style Section Heading', 'safariotravel' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'color_secttitle', [
                'label'     => esc_html__( 'Section Title Color', 'safariotravel' ),
        ...
        $this->add_control(
            'color_sectsubtitle', [
                'label'     => esc_html__( 'Section Sub Title Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
        ...
        $this->start_controls_section(
            'style_accordion', [
                'label' => esc_html__( 'Style Accordin', 'safariotravel' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'color_accordion_title', [
                'label'     => esc_html__( 'Accordion Title Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#000',
                'selectors' => [
        ...
        $this->add_control(
            'color_accordion_title_bg', [
                'label'     => esc_html__( 'Active Accordion Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_accordion_title_bg', [
                'label'     => esc_html__( 'Active Accordion Background Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#f7631b',
                'selectors' => [
        ...
        $this->add_control(
            'color_accordion_content', [
                'label'     => esc_html__( 'Accordion Content Color', 'safariotravel' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
    ...
    ?>
        <section class="course-mission-area pb-120">
            <div class="container">
                <?php
                    safariotravel_section_heading( $settings['sect_title'], $settings['sect_subtitle'] );
                ?>							
                <div class="row">
                    ...
                    <div class="col-md-6 video-right justify-content-center align-items-center d-flex relative">
                        ...
                        <a class="play-btn" href="<?php echo esc_url( $videoUrl ) ?>">
                            ...
                            if( $settings['paly_icon_select'] == 'image_icon' ){
                                echo '<img src="'. esc_url( $playImgIcon ) .'" alt="'. esc_html__( 'Play Button', 'safariotravel' ) .'">';
                            }else{
