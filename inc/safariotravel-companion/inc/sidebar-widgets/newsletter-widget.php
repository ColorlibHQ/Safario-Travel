...
class repair_newsletter_widget extends WP_Widget {
    ...
    function __construct() {
        ...
        'safariotravel_newsletter',


        // Widget name will appear in UI
        esc_html__( '[ Repair ] Newsletter Form', 'safariotravel' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer newsletter signup form.', 'safariotravel' ), )
        );
    ...
    <div id="mc_embed_signup" class="newsletter">
        ...
        <form action="<?php echo esc_url( $actionurl ); ?>" id="mc-embedded-subscribe-form" method="post">
            <div class="form-group">
                <input type="email" class="form-control" name="EMAIL" placeholder="<?php esc_html_e( 'Email address', 'safariotravel' ); ?>" required>
                <button class="sideabr_news_submit btn bb-btn" type="submit">
                    <span class="ti-email"></span>
                </button>
            </div>
            <button class="button rounded-0 primary-bg text-white w-100" type="submit"><?php echo esc_html__( 'Subscribe', 'safariotravel' ); ?></button>
            <div class="info"></div>
        </form>
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Newsletter', 'safariotravel' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'actionurl' ) ); ?>"><?php esc_html_e( 'Action URL:' ,'safariotravel'); ?></label>
            <p class="description"><?php esc_html_e( 'Enter here your MailChimp action URL.' ,'safariotravel'); ?> </p>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'desc' ) ); ?>"><?php esc_html_e( 'Short Description:' ,'safariotravel'); ?></label> 
