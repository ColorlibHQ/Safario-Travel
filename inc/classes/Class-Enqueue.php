...
class safariotravel_Enqueue {

	public $scripts = array();

	public function safariotravel_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'safariotravel_frontend_enqueue_scripts', ) );
	}

	public function safariotravel_frontend_enqueue_scripts( ) {
