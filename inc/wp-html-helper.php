...
// image default alt
if( ! function_exists( 'safariotravel_img_default_alt' ) ) {
	function safariotravel_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'safariotravel_img_tag' ) ) {
	function safariotravel_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = safariotravel_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'safariotravel_anchor_tag' ) ) {
	function safariotravel_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'safariotravel' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'safariotravel_heading_tag' ) ) {
	function safariotravel_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'safariotravel' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'safariotravel_paragraph_tag' ) ) {
	function safariotravel_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'safariotravel_other_tag' ) ) {
	function safariotravel_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'safariotravel_button_element ' ) ) {
	function safariotravel_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'safariotravel' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
