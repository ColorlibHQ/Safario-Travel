...
// Post Category
function safariotravel_post_cats() {
...
// Post Tags
function safariotravel_post_tags() {
...
// safariotravel comment template callback
function safariotravel_comment_callback( $comment, $args, $depth ) {
                ...
                <div class="user justify-content-between d-flex">
                    ...
                    <div class="desc">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <p class="date"><?php printf( __('%1$s at %2$s', 'safariotravel'), get_comment_date(),  get_comment_time() ); ?><?php edit_comment_link( esc_html__( '(Edit)', 'safariotravel' ), '  ', '' ); ?></p>
                            </div>
...
add_filter('comment_reply_link', 'safariotravel_replace_reply_link_class');
function safariotravel_replace_reply_link_class( $class ) {
